...
| sensi-backup | Backup File Detection Based on Files | 1 |
...
| Plugin Name | Description | Risk |
|:---:|:----:|:----:|
| sensi-backup | Backup File Scanning Based on Directories | 1 |
...
| sensi-backup | Backup File Detection Based on Domain | 1 |
