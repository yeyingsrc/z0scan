...
def cmd_line_parser(argv=None):
    ...
    # Requests options
    request = parser.add_argument_group("Request1", "Network request options")
    ...
    optimization.add_argument('-t', "--threads", dest="threads", type=int, default=config.THREAD_NUM, help="Max number of concurrent network requests (Default {})".format(config.THREAD_NUM))
    ...
    optimization.add_argument("-sf", '--skip-fingerprint', dest='skip_fingerprint', action="store_true", default=False, help="Skip the scan to fingerprints")
